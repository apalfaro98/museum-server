...
const armasValidations = {
    ...
    create: [
        ...
        check('manifestacion', 'La manifestación es obligatoria.')
            .not()
            .isEmpty(),
        check('denominacion', 'La denominación es obligatoria.')
            .not()
            .isEmpty(),
        ...
        check('gradoDeValor', 'El Grado de Valor es obligatorio.')
            .not()
            .isEmpty(),
